  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: 'Con permiso de catálogo ves la pestaña Configurar en Pedidos clientes: abrir caja del turno, take away, delivery, medios de pago, y alta/baja de ítems y extras.',
        items: [
        ...
        tip: 'CBU/alias y WhatsApp se cargan en Configuración del local → Pedidos. El alta directa de un cierre en Cierres sigue funcionando.',
      },
      {

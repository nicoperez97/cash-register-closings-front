...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        tip: 'Al abrir el diálogo se cargan de nuevo las cuentas. Si fallan, usá Reintentar.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: 'Al crear podés cargar sueldo diario, hora extra y multiplicador de feriado. Después eso se edita solo en Sueldos.',
        items: [
          ...
          'Entrada y salida de servicio: si las dejás vacías, usa las default del local.',
  ...
  },
  {
    id: 'payroll',
    title: 'Sueldos',
    summary: 'Sueldo diario, historial de aumentos y liquidación del mes.',
    blocks: [
      {
        ...
        tone: 'read',
        anyOf: ['payroll.read'],
        body: 'Ves el sueldo diario vigente, la hora extra y el multiplicador de feriado. Podés incluir empleados ocultos.',
        items: [
          'Si la hora extra está en 0, la liquidación usa sueldo diario ÷ horas del turno (entrada→retirada del empleado o del local).',
      ...
      },
      {
        ...
        tip: 'Si pasás de mensual a diario, cargá el valor diario a mano en cada empleado.',
      },
      {
        title: 'Historial',
        icon: 'history',
      ...
      },
      {
        ...
        tone: 'do',
        anyOf: ['payroll.manage'],
        body: 'Arriba ves el resumen (a pagar, presentismo, extras). En Período elegí el rango y el presentismo por semana, y tocá Generar. La liquidación suma sueldo diario × (días + feriados × mult) + extras + presentismo. “Separar por turnos” arma una fila por empleado y turno.',

...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          'Desde Pedidos: primero Abrir caja (cambio), después Generar cierre carga pedidos online (take away, delivery, mostrador) y mesas cobradas de Comanda del turno de ahora.',
          ...
          'Nuevo cierre directo: sigue funcionando aunque no hayas abierto caja desde Pedidos.',
          'Si la caja abierta es de otro día o turno, Generar cierre arma el de ahora y avisa el que quedó pendiente.',
          'En efectivo: cargá el total y a retirar se completa solo. Si dejás plata en caja, se descuenta de a retirar.',
    ...
    blocks: [
      {
        ...
        items: [
          'Comanda mozos: encendé el toggle. Aparece en Operación → Comanda (quien tenga el módulo Comanda) y también el link /mozo/….',
        ...
        tip: 'Quién ve Operación → Comanda se define en Usuarios (módulo Comanda), aparte de Pedidos clientes. Los permisos de /mozo y de la comanda staff son independientes.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Envíos y Resumen vienen colapsados: tocá la fila para expandir. Podés asignar varias promos de mesa (cupo por cada una). Las promos con vigencia (día u hoy) se aplican solas al abrir la mesa. En cada envío podés Reimprimir.',
          'Si después de emitir quitás un ítem o cambiás cantidad o precio, queda en Cambios (quién, hora y envío). También se ve en el historial de la mesa cerrada.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Si después de emitir quitás un ítem o cambiás cantidad o precio, queda en Cambios (quién y hora). En el Historial de la mesa cerrada también lo ves.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Operación: turnos de caja (también dan la entrada/retirada de presentismo), multiplicador de feriado (liquidación), producción, POS, concepto del retiro de efectivo, depósitos del cierre (efectivo, PVS, MP… a qué cuenta van) y francos.',
  ...
  },
  {
    id: 'admin-menu',
    title: 'Carta',
    summary: 'El menú que ve el cliente en /m y en /pedir: ítems, foto, disponibilidad, sectores y archivo físico.',
    blocks: [
      {
        title: 'Publicar',
        icon: 'restaurant_menu',
        ...
        items: [
          ...
          'Sectores: creá Cocina, Pizzería, Bar… Guardá con Guardar sectores. Con Asignar a ítems marcás varios platos de una vez. El print agent enlaza sector → comandera. Cada sector sale en su propia comanda. Mostrar entradas: esa comanda avisa en chico las entradas que salen en otro sector.',
          'En la lista: cada ítem es una fila compacta (nombre + precio + sectores). Tocá expandir para foto, descripción, precio texto e ingredientes.',

  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        tip: 'Usá Descargar plantilla o el Excel del contador. En la vista previa elegís módulos y asignás cuentas y conceptos del archivo a los del local, o los creás.',
      },
      {
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        tip: 'Importar Excel usa el mismo archivo del contador. En la vista previa marcá Ingresos y asigná cuentas y conceptos del archivo a los del local, o crealos.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        icon: 'lock',
        tone: 'lock',
        body: 'Editar y borrar un pago lo puede el super admin y las personas que él habilite en Usuarios. Crear, validar y abonar siguen con los permisos de siempre. Al guardar o borrar podés avisar a quien elijas; Todos los admins marca a los administradores del local.',
      },
    ],
  },
  {

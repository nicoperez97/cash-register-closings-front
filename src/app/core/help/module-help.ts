    ...
    blocks: [
      {
        ...
        items: [
          ...
          'En Posnets, cada terminal tiene Foto y Archivo. Si PVS o Mercado Pago se cargan a mano (sin terminal), también.',
          'En Cobros, Cuenta DNI y cada cuenta aparte (Pedidos Ya, Rappi, etc.) tienen Foto y Archivo. Podés adjuntar más de uno.',
          'Si te marcaron Archivos obligatorios, esos botones aparecen cuando el campo tiene monto. Sin monto, no se muestran. No deja guardar si falta el archivo.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'En Cierres, Archivos obligatorios si hay monto viene desmarcado. Si lo marcás, esa persona tiene que adjuntar foto o archivo en cada campo con valor.',

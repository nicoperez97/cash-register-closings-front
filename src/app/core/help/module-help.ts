...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    summary: 'Reparto igualitario entre socios, con dinero a dejar en canales.',
    blocks: [
      {
        title: 'Cómo se arma',
        icon: 'groups',
        ...
        body: 'Toma los saldos de socios y canales. El total menos lo que dejás en cada canal y los extras se reparte en partes iguales entre los socios marcados.',
        items: [
      ...
      },
      {
        ...
        body: 'Aplicar crea pases entre cuentas para dejar a cada socio con la misma parte y a cada canal con lo reservado.',
        tip: 'Guardá el armado si querés seguir después. Aplicar no se puede deshacer: quedan los pases en el libro.',
      },
    ],
  },
  {
...
const PATH_HELP: Array<{ test: (path: string) => boolean; id: string }> = [
  ...
  { test: (p) => p.startsWith('/partner-splits'), id: 'partner-splits' },

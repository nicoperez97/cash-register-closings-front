    ...
    blocks: [
      {
        ...
        tone: 'do',
        anyOf: ['shops.manage'],
        body: 'Primero Al comensal (reservas) y después Al equipo. Asunto y cuerpo por tipo; en el texto podés usar {shop} {guest} {name} {detail}.',
        tip: 'Reiniciar deja el texto original de ese mensaje.',
      },
    ],
  },
  {

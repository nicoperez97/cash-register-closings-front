    ...
    blocks: [
      {
        ...
        items: [
          ...
          'En Divisiones queda cada aplicación, y de ahí también se puede bajar el mismo PDF.',
      ...
      },
      {
        ...
        body: 'Aplicar crea pases entre cuentas para dejar a cada socio con la misma parte más lo reservado, y a cada canal con lo que dejaste. Cada aplicación se guarda en Divisiones, de donde también se puede bajar el PDF.',

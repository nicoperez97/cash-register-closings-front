    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Cuentas del local: cuentas del cierre (Efectivo, PVS, Mercado Pago, Pedidos Ya…) con cuenta destino y posnets anidados. Guardá con Guardar cuentas. Si las cuentas no aparecen, usá Reintentar.',

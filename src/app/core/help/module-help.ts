    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Efectivo en caja usa la cuenta de la fila Efectivo en Configuración del local → Cuentas del local (no otra cuenta cuyo nombre diga “efectivo”).',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          'Desde Pedidos: primero Abrir caja (el efectivo de apertura viene de lo dejado en el turno anterior; si no hay, del cambio por defecto). Después Generar cierre carga pedidos online (take away, delivery, mostrador) y mesas cobradas de Comanda del turno de ahora.',
          ...
          'En Cobros vas a ver líneas tipo «Pedidos mostrador…» y «Mesas · …»; tarjeta de mesa va a Posnets/card.',
          'Nuevo cierre directo: sigue funcionando aunque no hayas abierto caja desde Pedidos. La apertura también se completa con lo dejado en el turno anterior.',
          'Si la caja abierta es de otro día o turno, Generar cierre arma el de ahora y avisa el que quedó pendiente.',
          'En efectivo: contá con Contar, sin mirar el POS. Al cargar el total, a retirar se completa solo y no se edita. Si dejás plata en caja, se descuenta de a retirar y se propone como apertura del próximo turno.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'En Cobros, elegí tipo de pago (efectivo, transferencia, tarjeta u otro). El efectivo de un cobro se suma al efectivo total; el resto queda en Cobros.',
          ...
          'Efectivo de apertura: viene de lo que se dejó en caja el turno anterior. Si no hay cierre anterior, usa el cambio por defecto del local.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Completados muestra solo los del turno de ahora. Cancelados está al lado.',
      ...
      {
        title: 'Completados del turno',
        icon: 'check_circle',
        tone: 'read',
        anyOf: ['customerOrders.read'],
        body: 'La pestaña Completados lista solo los pedidos cerrados del turno de ahora (el mismo recorte de caja).',
        items: [
        ...
        tip: 'Si no hay caja abierta, Completados usa igual el horario del turno actual del local.',
      },
      {
      ...
      },
      {
        ...
        items: [
          'Antes de recibir pedidos online abrí la caja del turno. El efectivo de apertura viene de lo dejado en el turno anterior; si no hay, del cambio por defecto. Podés cambiarlo.',
          ...
          'Generar cierre (si podés crear cierres): arma el cierre del día y turno de ahora con pedidos online completados y mesas cobradas de Comanda, cierra pedidos online y abre el formulario. Si la caja abierta es de otro día o turno, te avisa que quedó un cierre pendiente de esa fecha y turno. Te avisa si hay pedidos o mesas abiertas. Al guardar se confirma el cierre.',
        ],
    ...
    blocks: [
      {
        ...
        tip: 'El tablero Pedidos clientes sigue siendo para el turno en curso. Completados no reemplaza este historial.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Operación: turnos de caja (también dan la entrada/retirada de presentismo), multiplicador de feriado (liquidación), producción, POS, cambio por defecto (si no hay cierre anterior), tope para pedir motivo de diferencia (0 = no pedir), concepto del retiro de efectivo y francos.',

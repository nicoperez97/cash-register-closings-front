  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        tip: 'Local abierto/cerrado apaga /pedir al instante. Generar cierre carga los montos en Cobros (con tipo de pago) y el efectivo en el paso Efectivo.',
      },
      {
      ...
      },
      {
        ...
        tone: 'do',
        anyOf: ['users.manage'],
        body: 'El acceso rápido «Catálogo pedidos» abre Pedidos online → Configurar (y también Carta). No hace falta entrar a la bandeja operativa.',
        tip: 'Es distinto del permiso Pedidos online (Ver / Todo) de la bandeja.',
      },
    ],
  },
  {
    id: 'admin-ordering',
    title: 'Pedidos',
    summary: 'Tipo de local, take away, delivery, horarios, zonas y pagos de /pedir.',
    blocks: [
      {
        title: 'Configurar pedidos online',
        icon: 'shopping_bag',
        tone: 'do',
        anyOf: ['shops.manage', 'orderingCatalog.manage'],
        body: 'En Configuración del local → Pedidos armás la página pública. Guardá con el botón al pie.',
        items: [
          'Tipo de local: al paso o restaurante (reservas y comanda). /pedir es siempre take away/delivery.',
          'Encendé Pedidos online. Activá take away y/o delivery según el local.',
          'Comanda (solo restaurante): encendé el toggle. Aparece en Operación → Comanda y también el link público /mozo/… Asigná un código mozo en Empleados para el acceso por PIN.',
    ...
    blocks: [
      {
        ...
        tip: 'Activá Comanda mozos en Configuración → Pedidos. El link público /mozo sigue disponible con PIN. Los colores de mesas siguen el acento del local (Identidad).',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          'Elegí una categoría con Ver. En cada producto tocá Agregar; después podés marcar en la lista los ingredientes a retirar (si el local los cargó), notas y extras.',
          'Si el local está cerrado ves los horarios de take away y delivery. Si además el local lo cerró manualmente, aparece un aviso específico.',
    ...
    blocks: [
      {
        ...
        items: [
          'Atajos: Presentismo (/p), Normas (/n), Carta (/m), Pedidos online (/pedir) y Reservas (/r) si el local los tiene activos.',
        ],
        tip: 'Pedidos online aparece solo si el local tiene pedidos online habilitados.',
      },
    ],
  },
  {

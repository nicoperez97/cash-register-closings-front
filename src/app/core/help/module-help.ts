...
export const HELP_TOPICS: HelpTopic[] = [
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Efectivo en caja es lo dejado en el último cierre (la misma cifra que propone Abrir caja). Si dejaste 0 o vacío, el KPI muestra 0. Con caja abierta, ves lo dejado en ese borrador (o la apertura si todavía no lo cargaste). Se actualiza al cambiar de local, al volver a la app y al tirar hacia abajo para refrescar. Abajo ves A retirar; tocá el KPI para ir a Retiros si tenés permiso.',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          'Desde Pedidos: primero Abrir caja (el efectivo de apertura es lo dejado en el último cierre; si no hay, el cambio por defecto). Después Generar cierre carga pedidos online (take away, delivery, mostrador) y mesas cobradas de Comanda del turno de ahora.',
          ...
          'Nuevo cierre directo: sigue funcionando aunque no hayas abierto caja desde Pedidos. La apertura también se completa con lo dejado en el último cierre.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Efectivo de apertura: es lo dejado en el último cierre. Si no hay cierre anterior, usa el cambio por defecto del local.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'También podés filtrar por concepto (incluídos Sin concepto y Concepto eliminado), facturado y texto en la descripción.',
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        title: 'Dividendos / división',
        icon: 'savings',
        tone: 'do',
        anyOf: ['accountTransfers.manage', 'accountTransfers.read'],
        body: 'La plata que el socio se lleva sale de su cuenta hacia la cuenta de división (por defecto Egreso, con concepto División). Se configura en Administración → Cuentas → División de socios. En la transferencia tildá Es dividendo; si es para alguien, elegí Para socio (opcional). También podés usar Enviar a dividendos.',
        tip: 'Ya no se usa una cuenta Dividendos aparte: es un egreso con concepto, configurable.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Aplicar abre un modal por cada pase: Pago (A socios, validado) o Movimiento. En ambos el dinero va a la cuenta configurada en Cuentas → División de socios (por defecto Egreso + concepto División); el beneficiario queda anotado y no le suma saldo. Por eso, después de aplicar, quien tenía Falta puede seguir en Falta en el saldo. Si elegís Pago, al marcarlo Pagado en A socios el movimiento queda como Es dividendo con Para socio = destino.',
          'Usar total saldos pone el monto = suma de saldos de socios (útil para repartir lo que hay según %).',
          'Si los saldos ya coinciden con el objetivo, Enviar a Dividendos saca el saldo de cada socio a la cuenta configurada.',
          ...
          'La cuenta y el concepto se eligen en Administración → Cuentas, bloque División de socios (Automático = Egreso + División).',
        ],
    ...
    blocks: [
      {
        ...
        tone: 'read',
        anyOf: ['reports.view'],
        body: 'Filtrá período y tipo (egreso, ingreso, transferencia). La tabla suma importes; los % cierran en 100%. Si el concepto fue archivado, ves el nombre original con “(eliminado)”, sin el texto técnico DELETED.',
      },
      {
        title: 'Descargar',
        icon: 'table_view',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          'Antes de recibir pedidos online abrí la caja del turno. El efectivo de apertura es lo dejado en el último cierre; si no hay, el cambio por defecto. Podés cambiarlo.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Cuentas del local: lista compacta de cuentas del cierre (Efectivo, PVS, Mercado Pago…). Tocá una fila para editar destino y posnets. La fila Efectivo fija la cuenta de caja para retiros y el libro. Agregar inserta debajo de Efectivo. Guardá con el botón Guardar de esa pantalla (no hay barra fija al pie).',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        tone: 'do',
        anyOf: ['concepts.manage'],
        body: 'Marcá varios conceptos y tocá Unificar. Elegís un destino (uno nuevo o uno ya existente). Pagos, gastos y movimientos de los de origen pasan al destino; los de origen se archivan. El destino queda activo y aparece en el reporte de conceptos.',
        tip: 'Cuidado al elegir el destino: el resto se archiva. Si unificás en uno existente, ese es el que tiene que quedar seleccionado en Destino.',
      },
      {
        title: 'Borrar varios',
        icon: 'delete_sweep',

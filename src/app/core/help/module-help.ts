    ...
    blocks: [
      {
        ...
        body: 'Está en Operación → Pedidos clientes. El tablero muestra pendientes, cocina, listos y en camino a la vez. Al entrar se ocultan la toolbar y el menú; podés mostrarlos con los botones flotantes.',
        items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        icon: 'download',
        tone: 'do',
        body: 'Arriba de la lista cargás el instalador por sistema operativo (Windows, macOS, Linux), con su versión: archivo o link de descarga.',
        items: [
          'Elegí Archivo o Link, el SO y la versión, y guardá.',
          'Reemplazá el mismo SO cuando haya una versión nueva.',
          'Cada local descarga el que necesite desde Configuración → Dispositivos.',
        ],
        tip: 'Si quitás un SO, ese botón de descarga desaparece en los locales hasta que cargues otro.',
      },
    ],
  },
  {

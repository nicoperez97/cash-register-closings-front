  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          'Desde Pedidos: primero Abrir caja (cambio), después Generar cierre carga pedidos online (take away, delivery, mostrador) y mesas cobradas de Comanda del mismo turno.',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Generar cierre (si podés crear cierres): arma el cierre de esa caja con pedidos online completados y mesas cobradas de Comanda, cierra pedidos online y abre el formulario. Te avisa si hay pedidos o mesas abiertas. Al guardar se confirma el cierre.',
        ],

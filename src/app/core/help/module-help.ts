    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Compartir de cada fila arma un PDF para el grupo. No uses imprimir del navegador.',
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          'En efectivo: contá con Contar, sin mirar el POS. Al cargar el total, a retirar se completa solo. Si dejás plata en caja, se descuenta de a retirar y se propone como apertura del próximo turno.',
          'En cuentas aparte y en Caja (sistema) podés subir foto, PDF o Excel: si se lee el total, se completa el monto.',
          'En Caja, primero cargás el total del POS (ticket Z o archivo). Lo que contaste no se ve hasta Revelar diferencia, para no acomodar los números. Si la diferencia llega al tope del local (Configuración → Operación), tenés que escribir el motivo.',
          'Compartir arma un PDF del cierre para el grupo (WhatsApp). No uses imprimir del navegador.',
        ],
        tip: 'El total declarado se compara con el POS recién cuando revelás la diferencia en Caja.',
      },
      {
        title: 'Bloquear',
        icon: 'lock',
    ...
    blocks: [
      {
        ...
        tone: 'do',
        anyOf: ['closings.create', 'closings.update'],
        body: 'Andá sección por sección: Posnets, Cobros, retiro y egresos, propinas, Efectivo y Caja. En Efectivo contá sin mirar el POS. En Caja cargás el total del sistema y recién ahí Revelar diferencia. Si el local tiene más de un turno, elegí en qué turno cerrás (viene el que está vigente: sigue hasta que abre el siguiente).',
        items: [
          ...
          'En Posnets, cada terminal tiene Foto y Archivo cuando cargás un monto. Si PVS o Mercado Pago se cargan a mano (sin terminal), también. No es obligatorio.',
          ...
          'En Cobros, Cuenta DNI y cada cuenta aparte (Pedidos Ya, Rappi, etc.): Foto y Archivo aparecen si hay monto. Podés adjuntar más de uno. No es obligatorio.',
          'En Caja, lo mismo para Caja (sistema): el total del POS. El archivo es opcional. Lo que contaste no se ve hasta Revelar diferencia.',
          ...
          'Compartir (en Resumen o al guardar) arma un PDF para el grupo. No uses imprimir del navegador.',
    ...
    blocks: [
      {
        ...
        body: 'Pendiente vs realizado, según las cuentas aparte del local (efectivo o depósito). En Inicio también ves el total que los canales todavía no rindieron.',
        items: [
        ...
        tip: 'Los “Días hasta acreditación” se configuran en el local, en cada cuenta aparte de tipo rendición (Pedidos Ya, Rappi, etc.).',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        tip: 'Quién ve Operación → Comanda se define en Usuarios (módulo Comanda), aparte de Pedidos clientes. Un local puede tener Comanda y Pedidos a la vez. Los permisos de /mozo y de la comanda staff son independientes.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Dispositivos: Comandas (token para Cierres-Comandas: en Todo podés Generar/Regenerar/Revocar; el token completo se copia al generarlo, después no se ve —si lo perdés, regenerá y pegalo de nuevo en la app—; descarga del instalador por SO —Windows, macOS o Linux— si un super admin lo publicó en Locales; la app también avisa si hay versión nueva y te deja descargarla sin borrar la configuración; las comanderas y qué platos salen en cada una se configuran en el Menú). Si hay dos PCs escuchando con el mismo token, cada comanda sale una sola vez. Si una comandera falla y otra ya imprimió, el reintento solo va a las que faltan. Posnets y Cuentas aparte (Pedidos Ya, etc.): cada fuente es una tarjeta; Guardar fuentes es aparte del pie de la página. En Cuenta destino podés elegir una cuenta o crear una nueva sin salir. En la cuenta podés cargar Comisión %: en Saldos el número grande ya la descuenta. Si las fuentes no aparecen, usá Reintentar.',
          ...
          'Cuentas canal: Administración → Cuentas. Los depósitos del cierre (efectivo, PVS…) se configuran en Operación o arriba de Cuentas.',
        ],
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Cada local descarga el que necesite desde Configuración → Dispositivos, o desde la misma app Cierres-Comandas.',
        ],
        tip: 'Si quitás un SO, ese botón de descarga desaparece en los locales hasta que cargues otro. Reinstalar no borra token ni comanderas.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Con Configuración del local en Ver o Todo podés definir Off / Ver / Todo por sección: Resumen, Identidad, Operación, Pedidos, Comandas, Dispositivos, Menú, Carta y Avanzado.',
    ...
    blocks: [
      {
        ...
        items: [
          'Arriba está Depósito del cierre: a qué cuenta canal va el efectivo, PVS, Mercado Pago, etc. Guardá con Guardar depósitos. El efectivo del día sale de Ingreso hacia la cuenta de Efectivo.',

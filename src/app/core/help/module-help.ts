...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    id: 'admin-shop',
    title: 'Local',
    summary: 'Cara del local: identidad, operación, dispositivos, menú y presentismo.',
    blocks: [
      {
        title: 'Configurar',
        icon: 'storefront',
        tone: 'do',
        anyOf: ['shops.manage'],
        body: 'Usá las pestañas: Identidad, Operación, Dispositivos, Menú y Avanzado.',
        items: [
          'Identidad: nombre, mails, logo y colores.',
          'Operación: turnos de caja (parten el día), entrada/retirada default del personal (aparte de los turnos), producción, POS, conceptos en pagos, módulos públicos y francos.',
          'Dispositivos: posnets y cuentas aparte (Pedidos Ya, etc.).',
          'Menú: grupos y módulos del menú lateral; con ⋮ renombrá, mové u ocultá.',
          'Cuentas canal y depósitos del cierre: Administración → Cuentas.',
          'Presentismo con entrada/salida: si lo apagás, el tablero es solo presente / ausente / feriado.',
          'iPad antiguo (iOS 9): usá /legacy/index.html. Safari viejo no puede abrir la app normal.',
        ],
        tip: 'Los turnos de caja no cambian la entrada/retirada del personal: eso sale del default del local o del empleado.',
      },
      {

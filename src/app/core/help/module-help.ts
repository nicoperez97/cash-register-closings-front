    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Generar cierre (si podés crear cierres): arma el cierre de esa caja con pedidos y mesas del turno, cierra pedidos online y abre el formulario. Al guardar se confirma el cierre.',
        ],
    ...
    blocks: [
      {
        ...
        tip: 'En la vista previa, Reemplazar solo aparece si ya hay un ítem con el mismo nombre. Guardá la carta después de aplicar. Si Gemini no está configurado, se usa parseo local.',
      },
    ],
  },
  {

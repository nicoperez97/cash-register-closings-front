...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    summary: 'Página para que el cliente arme el pedido y elija take away o delivery.',
    blocks: [
      {
        title: 'Cómo pedir',
        icon: 'storefront',
        ...
        items: [
          ...
          'Al confirmar vas a la página de tu pedido (/mi-pedido/…/CODIGO) y el estado se actualiza solo.',
        ],

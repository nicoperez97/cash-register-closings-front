...
export const HELP_TOPICS: HelpTopic[] = [
    ...
    blocks: [
      {
        ...
        tone: 'do',
        anyOf: ['closings.create', 'closings.update'],
        body: 'Andá sección por sección: Posnets, Cobros, retiro y egresos, propinas, Efectivo y Caja. Si el local tiene más de un turno, elegí en qué turno cerrás (viene el que está vigente: sigue hasta que abre el siguiente).',
        items: [
          ...
          'Si te marcaron Archivos obligatorios, no deja guardar si hay monto y falta el archivo.',
          'En Caja, lo mismo para Caja (sistema): el total del POS.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Al pie de la tabla (o abajo en el teléfono) ves el total del Monto según los filtros y la búsqueda.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Al pie de la tabla ves el total del Monto según los filtros y la búsqueda.',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: 'Si una cuenta tiene comisión, el número grande ya la descuenta. Abajo ves el total sin descontar y la comisión. En Cuentas → Mostrar esta cuenta en → Saldos elegís cuáles aparecen en este panel. Para ver todas las cuentas del local, abrí Cuentas → Saldos.',
      },
      {
        title: 'Transferir',
        icon: 'swap_horiz',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: 'Arriba ves canales y socios. Si una cuenta tiene comisión, el número grande ya la descuenta. Abajo ves el total sin descontar y el monto de la comisión.',
      },
      {
    ...
    blocks: [
      {
        ...
        items: [
          'En Saldos, si una cuenta tiene comisión, el número grande ya la descuenta. Abajo ves el total sin descontar y la comisión.',
        ],
      },
      {
        title: 'Descargar',
    ...
    blocks: [
      {
        ...
        body: 'Está en Operación → Pedidos clientes. El tablero muestra pendientes, cocina, listos y en camino a la vez.',
        items: [
          ...
          'En delivery, si Deliverate está activo, abrí el detalle y usá Solicitar Deliverate.',
        ],
      ...
      },
      {
        ...
        body: 'Con permiso de catálogo ves la pestaña Configurar en Pedidos clientes: local abierto/cerrado, take away, delivery, medios de pago, y alta/baja de ítems y extras.',
        items: [
          'Local abierto / cerrado: a mano. Si el turno ya empezó y sigue cerrado, ves un aviso. Abierto funciona aunque el turno aún no haya empezado.',
          'Al finalizar el turno el local se cierra solo y aparece un aviso.',
          'Guardá con el botón Guardar al pie. Ítems y extras vienen contraídos: tocá para expandir.',
          'Generar cierre (si podés crear cierres): arma el cierre del turno con pedidos online/mostrador y mesas cerradas (cobros por medio, propinas, comensales), y marca el local cerrado.',
        ],
        tip: 'CBU/alias y WhatsApp se cargan en Configuración del local → Pedidos.',
      },
      {
        ...
        tone: 'do',
        anyOf: ['users.manage'],
        body: 'En Administración → Usuarios, tipo Empleado, acceso rápido «Pedidos clientes». Solo ve esta bandeja (inicio en Pedidos clientes).',
      ...
      },
      {
        ...
        tip: 'Es distinto del permiso Pedidos clientes (Ver / Todo) de la bandeja.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        tip: 'Si al solicitar dice que el usuario no puede crear envíos, revisá la password del shop o pedile a Deliverate que confirme la asociación.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        body: 'En Configuración del local → Pedidos armás la página pública de pedidos. Guardá con el botón al pie.',
        items: [
          'Activá Página pública /pedir, Take away y/o Delivery según el local.',
          'Horarios: orientativos para el cliente; el abierto/cerrado real se maneja en Pedidos clientes → Configurar.',
          ...
          'En Pedidos clientes → Configurar: abierto/cerrado, take away, delivery, medios de pago e ítems/extras (no CBU ni WhatsApp).',
    ...
    blocks: [
      {
        ...
        tone: 'do',
        anyOf: ['shops.manage', 'orderingCatalog.manage'],
        body: 'En Configuración del local → Comandas activás la comanda y definís permisos. Guardá con el botón al pie.',
        items: [
          'Comanda mozos: encendé el toggle. Aparece en Operación → Comanda y también el link /mozo/….',
        ...
        tip: 'Los permisos de /mozo y de Operación → Comanda son independientes. Pedidos online están en Pedidos.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        icon: 'room_service',
        tone: 'do',
        body: 'En Operación → Comanda abrís el mapa del local activo (sin código mozo).',
        items: [
        ...
        tip: 'Activá Comanda mozos en Configuración → Comandas. El link público /mozo sigue disponible con PIN. Los colores de mesas siguen el acento del local (Identidad).',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        tip: 'Desde la app también está en Operación → Comanda (sin PIN). Los sectores son los de Salón → Mesas. No cobra ni va a caja.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    summary: 'Hub del local: identidad, operación, canales, comanda, dispositivos, menú y avanzado.',
    blocks: [
      {
        title: 'El resumen',
        icon: 'storefront',
        ...
        items: [
          ...
          'Pedidos: página /pedir, take away, delivery, horarios, zonas y pagos online. La bandeja está en Operación → Pedidos clientes.',
          'Comandas: activar comanda mozos, link /mozo, medios de pago de mesa y permisos por canal.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'En Cierres ves Archivos obligatorios si hay monto (desmarcado por defecto). Activá Crear/Ver/Editar/Bloquear para poder tildarlo; con Off queda deshabilitado. Si lo marcás, no deja guardar sin foto o archivo en cada campo con valor.',
          'Si asociás una cuenta Socio, podés cargar el % de división de esa cuenta (para Equilibrar en Divisiones).',
  ...
  },
  {
    id: 'admin-menu',
    title: 'Carta',
    summary: 'El menú que ve el cliente en /m y en /pedir: ítems, foto, disponibilidad y archivo físico.',
    blocks: [
      {
        title: 'Publicar',
        icon: 'restaurant_menu',
        ...
        items: [
          'Agregar / Reemplazar: Gemini arma ítems y sugiere “Se puede pedir sin” según nombre y descripción.',
          ...
          'En cada ítem: precio, Disponible online (para /pedir), Foto e “Ingredientes de este ítem (se puede pedir sin)” separados por coma.',
        ...
        tip: 'Si Gemini no está configurado, Agregar carta usa parseo local (sin ingredientes). Detectar ingredientes requiere Gemini.',
      },
    ],
  },
  {

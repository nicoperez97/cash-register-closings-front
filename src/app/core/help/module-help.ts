  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: 'Al pasar presente se copian la entrada y salida del empleado (si las tiene) o las default del local. El turno de caja solo elige la fila del día, no esas horas.',
        items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          'Entrada y salida de servicio: si las dejás vacías, usa las default del local (no las del turno de caja).',
          'Eso alimenta el extra del presentismo cuando el local marca con entrada y salida.',
        ],
        tip: 'Al abrir la ficha se cargan de nuevo usuarios y productores. Si fallan, usá Reintentar.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Operación: turnos de caja (parten el día), entrada/retirada del personal, producción, POS, conceptos en pagos, módulos públicos y francos.',

  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        tip: 'Activá «Administrador de pedidos online» para notificaciones. Con Pedidos clientes (Ver/Todo) o Catálogo pedidos podés marcar qué ve en Configurar. Para mesas usá el preset o módulo Comanda.',
      },
      {
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        icon: 'download',
        tone: 'do',
        body: 'Arriba de la lista cargás un instalador por sistema operativo (Windows, macOS, Linux), con su versión.',
        items: [
          'Reemplazá el archivo del mismo SO cuando haya una versión nueva.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Con Pedidos clientes o Catálogo pedidos podés marcar qué ve en Pedidos → Configurar: caja, canales, pagos, ítems y extras.',

    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Mostrador entra en En cocina. Delivery entra como pedido delivery (después podés Solicitar Deliverate en el detalle).',
        ],
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'En Cierre de caja elegí qué hacer con el monto (hoy / después / solo registrar) y la cuenta del local si aplica.',
          ...
          'En el detalle ves nº Deliverate, repartidor, demoras, distancia, costo y avisos (alta demanda, ayuda, etc.).',

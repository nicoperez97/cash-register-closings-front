...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    id: 'admin-ordering',
    title: 'Pedidos',
    summary: 'Tipo de local, take away, delivery, pedido en mesa, horarios, zonas y pagos de /pedir.',
    blocks: [
      {
        ...
        items: [
          'Tipo de local: al paso (take away/delivery) o restaurante (el cliente elige mesa en el mapa de /pedir; también podés usar reservas).',
          'Encendé Pedidos online. En restaurante, /pedir muestra Pedir en mesa además de take away/delivery si los activás.',
          'Comanda mozos (solo restaurante): encendé el toggle y copiá el link /mozo/… Asigná un código mozo en Empleados.',
    ...
    blocks: [
      {
        ...
        tip: 'Los sectores son los de Salón → Mesas. No cobra ni va a caja. Activá Comanda mozos en Pedidos y asigná código mozo en Empleados. El cliente también puede pedir en mesa desde /pedir.',
      },
    ],
  },
  {
    ...
    summary: 'Página para que el cliente arme el pedido: mesa (restaurante), take away o delivery.',
    blocks: [
      {
        title: 'Cómo pedir',
        icon: 'storefront',
        tone: 'do',
        body: 'Entrá a /pedir/tu-local. Según el tipo de local vas a mesa o a take away/delivery.',
        items: [
          'Restaurante: tocá Pedir en mesa, elegí en el mapa, indicá comensales y armá el pedido. Enviar a cocina usa la misma lógica que el mozo (la mesa se ocupa al primer envío).',
          'Al paso o para llevar: elegí productos, revisá el carrito y finalizá con entrega, pago y tus datos.',
          ...
          'Al confirmar take away/delivery vas a /mi-pedido/…/CODIGO. En mesa, tras enviar volvés al mapa.',
        ],
        tip: 'La carta de solo lectura sigue en /m. Esta página es para pedir.',
      },
    ],
  },
  {

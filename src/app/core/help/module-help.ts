  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: 'Si una cuenta tiene comisión, el número grande ya la descuenta. Abajo ves el total sin descontar y la comisión.',
      },
      {
        title: 'Transferir',
        icon: 'swap_horiz',
      ...
      },
      {
        ...
        body: 'Hay una sola cuenta Dividendos por local. El dinero sale del socio origen y va a Dividendos: no suma saldo al otro socio. En la transferencia tildá Es dividendo; si es para alguien, elegí Para socio (opcional). También podés usar Enviar a dividendos.',
        tip: 'Socio → socio normal sí mueve saldos. Dividendo nunca entra al saldo del beneficiario.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        title: 'Divisiones: Historial y Equilibrar',
        icon: 'balance',
        tone: 'do',
        anyOf: ['partnerSplits.read'],
        body: 'En Divisiones hay dos pestañas. Historial lista lo aplicado. Equilibrar usa un monto de referencia y el % de cada cuenta socio.',
        items: [
          ...
          'Aplicar pases abre un modal: cada pase puede ser Pago (A socios) o Movimiento (libro entre cuentas).',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Dividendos: una sola cuenta por local, se crea sola. No se borra. Ahí se acumula lo que los socios envían como dividendo.',

...
export const HELP_TOPICS: HelpTopic[] = [
    ...
    blocks: [
      {
        ...
        tone: 'do',
        anyOf: ['closings.create', 'closings.update'],
        body: 'Andá sección por sección: Posnets, Efectivo, Cobros, retiro y egresos, propinas y Caja. Si el local tiene más de un turno, elegí en qué turno cerrás (viene el que está vigente: sigue hasta que abre el siguiente).',
        items: [
  ...
  },
  {
    ...
    summary: 'Pedidos de clientes por take away o delivery. Las mesas van por reservas.',
    blocks: [
      {
        title: 'La bandeja',
        icon: 'shopping_bag',
        ...
        body: 'Acá llegan los pedidos de la página pública /pedir. Filtrá activos, pendientes o completados. Se actualiza solo cuando entra uno nuevo.',
        items: [
          'Cada tarjeta muestra código, cliente, canal (take away o delivery), pago e ítems.',
          'En delivery ves zona y dirección.',
        ],
        tip: 'Arriba están Página pública y Copiar link. Está en Configuración del local; se enciende en Pedidos.',
      },
      {
        ...
        body: 'Pasá el pedido: Aceptar → Preparar → Listo. En delivery podés marcar En camino y después Completar. También podés cancelar.',
        tip: 'El cliente consulta el estado en /mi-pedido con celular y código.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Definí ETA, efectivo/transferencia y zonas de delivery.',
          'La carta con precios se carga en Configuración del local → Carta.',
        ],
        tip: 'Guardá con el botón fijo al pie. Con el módulo encendido ves Página pública y Copiar link.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          'Elegí una categoría con Ver. En cada producto tocá Agregar; después podés ajustar cantidad y notas.',
          ...
          'Al terminar recibís un código para seguir el pedido en Consultar estado.',
        ],
  ...
  },
  {
    ...
    summary: 'Mirás el estado de tu pedido con celular y código.',
    blocks: [
      {
        title: 'Consulta',
        icon: 'search',
        tone: 'read',
        body: 'En /mi-pedido/tu-local ingresá el celular y el código que te dieron al finalizar.',
        tip: 'Si no aparece, revisá el código (sin espacios) y el número sin 0 ni 15.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Pedidos: take away/delivery, horarios, zonas y pagos de /pedir. La bandeja está en Pedidos online.',
    ...
    blocks: [
      {
        ...
        tone: 'do',
        anyOf: ['shops.manage'],
        body: 'Podés tener varias cartas (comida, vinos…). La página pública existe si el módulo está activo en Configuración del local → Operación. La carta vive en Configuración del local.',
        items: [

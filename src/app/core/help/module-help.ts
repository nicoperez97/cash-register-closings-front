...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    summary: 'Hub del local: identidad, operación, canales, comanda, cuentas del local, menú y avanzado.',
    blocks: [
      {
        title: 'El resumen',
        icon: 'storefront',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Cada local descarga el que necesite desde Configuración → Operación (Comandas / impresora), o desde la misma app Cierres-Comandas.',
        ],
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Con Configuración del local en Ver o Todo podés definir Off / Ver / Todo por sección: Resumen, Identidad, Operación, Pedidos, Comandas, Cuentas del local, Menú, Carta y Avanzado.',

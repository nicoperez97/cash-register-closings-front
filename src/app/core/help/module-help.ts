    ...
    blocks: [
      {
        ...
        body: 'En Operación → Comanda abrís el mapa del local activo (sin código mozo). Es independiente de Pedidos clientes.',
        items: [
          ...
          'Envíos y Resumen vienen colapsados: tocá la fila para expandir. Podés asignar varias promos de mesa (cupo por cada una). En cada envío podés Reimprimir.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'El carrito se contrae a un badge con cantidad; tocá Detalle para +/- y la nota. Solo la lista hace scroll.',
          'Tras Enviar volvés al mapa/lista. Retomá mesas ocupadas para más envíos o el ticket cliente.',
          'Envíos y Resumen vienen colapsados: tocá la fila para expandir. Podés asignar varias promos de mesa. En cada envío podés Reimprimir.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'En la lista: cada ítem es una fila compacta (nombre + precio). Tocá expandir para foto, descripción, precio texto e ingredientes.',
        ...
        tip: 'En la vista previa, Reemplazar solo aparece si ya hay un ítem con el mismo nombre. Guardá la carta después de aplicar o de ajustar precios. Si Gemini no está configurado, se usa parseo local.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Con composición, cargar el pack o los ítems a mano es lo mismo: el ticket arma los packs solos. El cupo (vacío = ilimitado) se define al asignar la promo en la mesa, no acá. Horario: fuera de ventana se ve atenuada.',
        ],

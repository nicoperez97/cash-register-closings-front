  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: 'Hay una sola cuenta Dividendos por local (se crea sola). Por defecto ahí va la plata que el socio se lleva / ya no está disponible para el local: baja del saldo del socio origen y no suma al otro. Podés cambiar la cuenta y el concepto en Administración → Cuentas → División de socios. No aparece en el panel lateral de Saldos; sí en Cuentas → Saldos. En la transferencia tildá Es dividendo; si es para alguien, elegí Para socio (opcional). También podés usar Enviar a dividendos.',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Aplicar abre un modal por cada pase: Pago (A socios, validado) o Movimiento. En ambos el dinero va a la cuenta configurada en Cuentas → División de socios (por defecto Dividendos); el beneficiario queda anotado y no le suma saldo. Por eso, después de aplicar, quien tenía Falta puede seguir en Falta en el saldo. Si elegís Pago, al marcarlo Pagado en A socios el movimiento queda como Es dividendo con Para socio = destino.',
          'Usar total saldos pone el monto = suma de saldos de socios (útil para repartir lo que hay según %).',
          'Si los saldos ya coinciden con el objetivo, Enviar a Dividendos saca el saldo de cada socio a la cuenta configurada (deja de estar disponible para el local / no aparece en Saldos).',
          ...
          'La cuenta y el concepto de destino se eligen en Administración → Cuentas, bloque División de socios.',

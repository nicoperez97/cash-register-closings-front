...
export const HELP_TOPICS: HelpTopic[] = [
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Tocá la tarjeta para ver el detalle completo y volver a un estado anterior.',
      ...
      },
      {
        ...
        items: [
          ...
          'Abrí el pedido (tocá la tarjeta) para ver todos los datos y volver atrás (p. ej. de Listos a cocina).',
        ],
      ...
      },
      {
        ...
        items: [
          ...
          'Generar cierre (si podés crear cierres): arma el cierre del turno vigente con cobros por tipo de pago (efectivo/transferencia), unidades y una nota corta del turno, y marca el local cerrado.',
        ],
        tip: 'CBU/alias y WhatsApp se cargan en Configuración del local → Canales.',
      },
      {
  ...
  },
  {
    id: 'admin-ordering',
    title: 'Canales',
    summary: 'Página /pedir, comanda, take away, delivery, horarios, zonas y pagos.',
    blocks: [
      {
        ...
        body: 'En Configuración del local → Canales armás la página pública y la comanda. Guardá con el botón al pie.',
        items: [
          'Activá Página pública /pedir, Take away y/o Delivery según el local.',
          'Comanda mozos: encendé el toggle. Aparece en Operación → Comanda y también el link /mozo/… Asigná un código mozo en Empleados para el acceso por PIN.',
          'Medios de pago de mesa: nombre + cuenta opcional del local. Se usan al cerrar la mesa.',
          'Las mesas del mapa de comanda se cargan en Salón → Mesas (vista Mapa).',
          ...
          'Crear/editar extras, ítems y fotos: en Carta. Horarios, zonas y ETA: Configuración del local → Canales.',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'En Envíos ves cada comanda con la hora. Abajo, el Resumen permite cambiar precio, cantidad o quitar extras.',
          'Ticket: descuento en % o $ antes de imprimir. Sin ticket no se puede cerrar la mesa.',
          'Al cerrar, elegí la forma de pago (se configuran en Canales, con cuenta opcional).',
          ...
          'Cerrar mesa: solo después del ticket, eligiendo el medio de pago.',
        ],
        tip: 'Activá Comanda mozos en Configuración → Canales. El link público /mozo sigue disponible con PIN. Los colores de mesas siguen el acento del local (Identidad).',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Cerrar mesa: primero imprimí el ticket y después elegí el medio de pago.',
        ],
  ...
  },
  {
    id: 'employees',
    title: 'Empleados',
    summary: 'Ficha de cada persona: tipo, horario de servicio y vínculo a la app.',
    blocks: [
      {
        title: 'El listado',
        icon: 'badge',
        ...
        body: 'Fijo o rotativo por turno, si cuenta para presentismo, si produce comida, y lo visible según tus permisos.',
      },
      {
        title: 'La ficha',
        icon: 'tune',
  ...
  },
  {
    ...
    summary: 'Hub del local: identidad, operación, dispositivos, menú y avanzado.',
    blocks: [
      {
        title: 'El resumen',
        icon: 'storefront',
        ...
        items: [
          ...
          'Pedidos: Canales (página /pedir, comanda, horarios, zonas y pagos). La bandeja está en Operación → Pedidos clientes.',

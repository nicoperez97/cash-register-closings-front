    ...
    blocks: [
      {
        ...
        items: [
          'Agregar / Reemplazar: Gemini lee el archivo y abre una vista previa para elegir qué cargar, reemplazar u omitir (también sugiere “Se puede pedir sin”).',
          'Detectar ingredientes: vuelve a analizar con Gemini los ítems ya cargados (podés editarlos antes de guardar).',
          'Carta física: el PDF o la foto que se abre en la web.',
          ...
          'En la lista: cada ítem es una fila compacta (nombre + precio + sectores). Tocá expandir para foto, descripción, precio texto, ingredientes y receta.',
          ...
          'Ajustar precios: diálogo para poner un monto fijo o un % a los ítems que marques (también podés marcarlos antes en la lista).',
